...
public class TmIpUtil {
	...
	public static String ipLocation(String ip) {
		String ipLocation = "";
		TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat","C:/tomcat/plugin/ip/");//F:/tzmusic2/WebRoot/WEB-INF/ip/
	...
	public static String ipprovince(String ip) {
		String ipLocation = "";
		TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat","C:/tomcat/plugin/ip/");
