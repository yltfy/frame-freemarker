...
public class TmIPSeeker {
	...
	//保存的文件夹
	private static String INSTALL_DIR="f:/qqwry";
	
	public static String FILE_NAME = "qqwry.dat";
	
	public static String FILE_PATH =  "/WEB-INF/plugin/ip";
	...
	public TmIPSeeker(String fileName,String dir)  {
	...
	public IPLocation getIPLocation(String ip){
		...
		if(TmStringUtils.isNotEmpty(ip) && !ip.equals("127.0.0.1")){
			location.setArea(this.getArea(ip));
			location.setCountry(this.getCountry(ip));
		}else{
			location.setCountry("本地");
		}
		return location;
	}
